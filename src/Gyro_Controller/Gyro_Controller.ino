...
void signal_transmit(){
  switch (mode) {
    ...
    case 1:{//자이로 등속제어
      ...
      else if(current_x < -30){//전진
        bluetooth.write('w');
      }
      else if(30 < current_x && current_x < 70){//후진
        bluetooth.write('s');
      }
      else{//정지
        bluetooth.write('e');
    ...
    case 2:{//자이로 플렉스 가변속제어
      ...
      if(700<=flexVal && flexVal<780){
        bluetooth.write('1');
      }
      else if(780<=flexVal && flexVal<810){
        bluetooth.write('2');
      }
      else if(810<=flexVal && flexVal<840){
        bluetooth.write('3');
      }
      else if(840<=flexVal && flexVal < 870){
        bluetooth.write('4');
      }
      else{
        bluetooth.write('5');
